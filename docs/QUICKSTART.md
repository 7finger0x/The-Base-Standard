...
# Note: If using Base Sepolia, ensure your ponder.config.ts supports chainId 84532
...
# Get DATABASE_URL from the Ponder service in Railway dashboard
...
# Note: Use Sepolia RPC/Chain ID if you deployed to testnet in Step 1
